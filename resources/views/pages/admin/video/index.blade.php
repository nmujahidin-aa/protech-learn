            ...
            <div class="col-sm mb-2 mb-sm-0">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-no-gutter">
                        ...
                        <li class="breadcrumb-item text-muted" aria-current="page">video</li>
                    </ol>
                </nav>
            </div>

            <div class="col-auto">
                <a class="btn btn-primary" href="{{route('dashboard.video.edit')}}">
                ...
                <tbody class="fw-semibold text-gray-600">
                    ...
                    <tr class="odd">
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="d-flex justify-content-start flex-column">
                                    <a href="{{route('dashboard.video.edit',$row->id)}}" class="text-dark fw-bolder text-hover-primary mb-1">
                                        <span class="mb-0">{{$row->title}}</span><br>
                                        <a href="{{$row->url}}" class="mb-0">Lihat Video</a><br>
                                    </a>
                                </div>
                            </div>
                        </td>
                        ...
                        <td>
                            ...
                            <a class="btn btn-light-primary btn-sm" href="{{route('dashboard.video.edit', $row->id)}}">
        ...
        $(document).on("click", ".btn-delete", function(){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $("#frmDelete").attr("action", "{{ route('dashboard.video.single_destroy', '_id_') }}".replace("_id_", id));
