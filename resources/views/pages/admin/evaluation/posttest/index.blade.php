    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col-sm mb-2 mb-sm-0">
                <h1 class="page-header-title">Soal Posttest</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-no-gutter">
                        ...
                        <li class="breadcrumb-item text-muted" aria-current="page">Posttest Paket {{$id}}</li>
                    </ol>
                </nav>
            </div>

            <div class="col-auto">
                <a class="btn btn-primary" href="{{route('dashboard.evaluation.posttest.edit', $id)}}">
                ...
                @if ($questions->count() > 0)
                    ...
                    <div class="d-flex justify-content-between align-items-start mb-5">
                        <div class="d-flex ">
                            ...
                            <div>
                                <a href="{{route('dashboard.evaluation.posttest.edit', [$id, $row->id])}}" class="text-dark text-hover-primary fs-6 fw-bolder">{!! $row->question !!}</a>
                                <div>
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <li>
                                    <a class="dropdown-item" href="{{route('dashboard.evaluation.posttest.edit', [$id, $row->id])}}">
                                        <i class="fa fa-edit me-2"></i> Edit
                                    </a>
                                </li>
                                <li>
                                    <form action="{{route('dashboard.evaluation.posttest.delete', $row->id)}}" method="POST">
                                        @csrf
                                        @method('DELETE')
