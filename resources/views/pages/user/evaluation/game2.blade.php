...
<head>
  ...
  <!-- version: 3.7.20003.0 -->
  <title>PROTECH (PROTISTS ELECTRONIC CHARTA)</title>
...
<body style="background: #FFFFFF" class="cs-HTML is-theme-classic" role="application">
  ...
  <script>
    window.globals = {
      ...
      aid: '',
      cid: '844b4cad-4c49-4f28-88e3-79ab0bb40144',
  ...
  <div class="mobile-load-title-overlay">
    <div class="mobile-load-title">PROTECH (PROTISTS ELECTRONIC CHARTA)</div>
  </div>
  <script>
  ...
  <link rel="stylesheet" href="{{URL::to('/')}}/html5/lib/stylesheets/main.min.css" data-noprefix />
  <link rel="stylesheet" href="{{URL::to('/')}}/html5/data/css/output.min.css" data-noprefix />
  <script data-main="app/scripts/init.generated" src="{{URL::to('/')}}/html5/lib/scripts/app.min.js"></script>
</body>
</html>
