        ...
        <div class="card px-2 pt-8" style="background-color: rgba(0, 0, 0, 0.4); border: 5px solid #cccccc; max-height: 75%;">
            <div class="card-body" style="max-height: 70vh; overflow-y: auto; padding: 10px; scrollbar-width: none; -ms-overflow-style: none;">
                    ...
                    <div class="col-xl-4 mb-xl-10">
                        ...
                        <div class="card h-md-100" data-bs-theme="light" style="background-image: url('{{ asset('assets/media/misc/auth-bg.png') }}');">
                            ...
                            <div class="card-body d-flex flex-column pt-13 pb-14">
                                ...
                                <div class="m-0">
                                    <!--begin::Title-->
                                    <h1 class="fw-bold text-white text-center mb-0" style="font-size: 40px;">Selamat !!!</h1>
                                    <br/>
                                    <div class="text-center">
                                        <span class="fw-bolder text-white mb-0">Anda telah mengerjakan </span>
                                        <br>
                                        <span class="fw-normal text-white mb-0">Pre Test paket {{$id}}</span>
                                    </div>
                                    <!--end::Title-->
                                    <!--begin::Illustration-->
                                ...
                                <div class="text-center">
                                    ...
                                    <!--begin::Link-->
                                    <div class="text-center">
                                        <span class="fw-bolder text-white mb-0">Adalah skor anda </span>
                                    </div>
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header pt-5">
                                ...
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold text-gray-900">Riwayat Post Test</span>
                                    <span class="text-gray-500 mt-1 fw-semibold fs-6">{{$userTest->created_at}}</span>
                                </h3>
                                <!--end::Title-->
                            </div>
                            <!--end::Header-->
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade active show" id="kt_chart_widget_11_tab_content_3" role="tabpanel">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <!--end::Statistics-->
                                            <!--begin::Description-->
                                            <span class="fs-6 fw-semibold text-gray-500">Anda berhasil menjawab <b>{{$correctAnswersCount}}</b> Soal dengan benar.</span><br>
                                            <span class="fs-6 fw-semibold text-gray-500">Kamu dapat melanjutkan Pembelajaran</span>
                                            <!--end::Description-->
                                        </div>
                                        <!--end::Statistics-->
                                        <!--begin::Chart-->
                ...
                <div class="d-flex justify-content-center" style="position: absolute; bottom: -25px; right: 10px;">
                    <a href="{{route('evaluation.posttest')}}" class="circlebutton">
