    ...
    <div style="width: 90%">
        <div class="card px-2 pt-8" style="background-color: rgba(0, 0, 0, 0.4); border: 5px solid #cccccc; max-height: 75%;">
            <div class="card-body" style="max-height: 70vh; overflow-y: auto; padding: 10px; scrollbar-width: none; -ms-overflow-style: none;">
                <div class="titlecard">
                    <div class="bg-light rounded py-3" style="border: solid 3px #cccccc;"><h1 class="custom-font px-10">Posttest</h1></div>
                </div>
                            ...
                            <div class="card-body d-flex flex-column pt-13 pb-14">
                                ...
                                <div class="m-0">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <br>
                                        <span class="fw-normal text-white mb-0">memulai post test paket {{$id}} ini</span>
                                    </div>
                                    <!--end::Title-->
                                    <!--begin::Illustration-->
                                ...
                                <div class="text-center">
                                    ...
                                    <!--end::Link-->
                                    <!--begin::Link-->
                                    <a class="btn btn-sm bg-white btn-color-white bg-opacity-20" href="{{route('evaluation.posttest.show', [$id, $questionNumber])}}">Mulai Test</a>
                                    <!--end::Link-->
                                </div>
                                <!--end::Links-->
                            </div>
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header pt-5">
                                ...
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold text-gray-900">Silahkan melakukan post test</span>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade active show" id="kt_chart_widget_11_tab_content_3" role="tabpanel">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <!--end::Statistics-->
                                            <!--begin::Description-->
                                            <span class="fs-6 fw-semibold text-gray-500">Jangan lupa <b>berdoa</b> sebelum mengerjakan post test.</span><br>
