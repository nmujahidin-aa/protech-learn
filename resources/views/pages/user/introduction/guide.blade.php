            ...
            <div class="card-body" style="max-height: 70vh; overflow-y: auto; padding: 10px; scrollbar-width: none; -ms-overflow-style: none;">
                <div class="bg rounded" style="background-color: #9945d6;">
                    <div class="py-3 px-3 text-light d-flex align-items-center">
                        ...
                        <p class="fw-bold fs-2 mb-0 recoleta">Panduan Penggunaan Media</p>
                    </div>
                </div>
                @if ($introduction)
                    <p class="text-light">{!! $introduction->guide !!}</p>
                @else
                    <p class="text-center text-danger pt-10 recoleta">-- Panduan Penggunaan Media Belum Dibuat --</p>
                @endif
            </div>
        </div>
    </div>
